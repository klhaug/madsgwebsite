            ...
            <div className="md:mx-24 my-4 mx-4 flex h-screen justify-center items-center">
                <div className="max-w-[1300px] flex flex-wrap gap-8 justify-center items-center md:flex-nowrap" >
                    ...
                    <div className="flex flex-col gap-4 justify-center max-w-[715px]">
                        ...
                        <Link className="flex md:max-w-[175px] justify-center items-center h-11 px-6 font-sec bg-blue-main hover:bg-blue-hover text-white" href={"/"}><Image src={"/static/arrow_back_24dp_FDFDFD_FILL0_wght400_GRAD0_opsz24.svg"} width={20} height={20} alt="back arrow svg" /> Tilbake</Link>
                    </div>
            </div>
            </div>
        </div>
